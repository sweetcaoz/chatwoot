...
ActiveRecord::Schema[7.1].define(version: 2025_07_14_104358) do
  ...
  create_table "kanban_stages", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.string "board_key", default: "sales", null: false
    t.string "key", null: false
    t.string "name", null: false
    t.string "color"
    t.string "icon"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "board_key", "active"], name: "index_kanban_stages_active"
    t.index ["account_id", "board_key", "key"], name: "index_kanban_stages_unique_key", unique: true
    t.index ["account_id", "board_key", "position"], name: "index_kanban_stages_position"
